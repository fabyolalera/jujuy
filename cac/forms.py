...
from .models import Categoria, Curso, EstudianteM, Proyecto
...
class ContactoForm(forms.Form):
    ...
    suscripcion = forms.BooleanField(
            label='Deseo suscribirme a las novedades de información turística',
            required=False,
    ...
    def clean(self):
        ...
        if "Jujuy" not in asunto or "Jujuy" not in mensaje:
            msg = "Debe agregar la palabara 'Jujuy' en el campo."
